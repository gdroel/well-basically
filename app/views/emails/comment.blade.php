...
<html lang="en-US">
    ...
    <body style="background-color:#428bca; padding:50px;">
        <h1 style="@import url(http://fonts.googleapis.com/css?family=Lobster);color:white;font-family:'Lobster',sans-serif;">Well Basically</h1>
        <hr>
        ...
        <br>
        <p style="color:white"><a style="color:white" href="{{ URL::to('/') }}">Well Basically</a></p>
    </body>
</html>